Blockly.JavaScript['http_request'] = function(block) {
  ...
  var value_token_ = Blockly.JavaScript.valueToCode(block, 'value_token_', Blockly.JavaScript.ORDER_ATOMIC);
  var value_data_ = Blockly.JavaScript.valueToCode(block, 'value_data_', Blockly.JavaScript.ORDER_ATOMIC);
